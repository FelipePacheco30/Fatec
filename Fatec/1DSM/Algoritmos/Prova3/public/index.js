...
async function calcularMedia() {
  ...
  try {
    const res = await fetch(
      `http://localhost:3100/operacoes/media?numeros=${numeros}`
    );
...
async function calcularFatorial() {
  ...
  try {
    const res = await fetch(
      `http://localhost:3100/operacoes/fatorial?numero=${numero}`
    );
    const data = await res.json();
...
async function calcularSomatorio() {
  ...
  try {
    const res = await fetch(
      `http://localhost:3100/operacoes/somatorio?inicio=${inicio}&fim=${fim}`
    );
    const data = await res.json();
...
async function calcularPrimo() {
  ...
  try {
    const res = await fetch(
      `http://localhost:3100/operacoes/primo?numero=${numero}`
    );
    const data = await res.json();
